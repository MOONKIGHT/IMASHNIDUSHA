...
const Queendiana = require('../diana');
...
if (config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: true }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'autobio ?(.*)', fromMe: true, desc: auto_dsc, usage: '.autobio on / off' }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'detectlang$', fromMe: true, desc: dlang_dsc }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: true }, (async(message, match) => {
    ...
    if (config.LANG == 'TR' || config.LANG == 'AZ') {
        ...
        diana.addqueendiacmd({ queeendiacmd: 'tts (.*)', fromMe: true, desc: Lang.TTS_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'number', fromMe: false, desc: Lang.NUMBER }, (async(message, match) => {

        const p_lk = 'BEGIN:VCARD\n' +
            'VERSION:3.0\n' +
            'FN:' + Queendiana.OA_NAME + '\n' //created afnanplk, please copy this with credit..
            +
            'ORG:Diana Diana fam;\n' +
            'TEL;type=CELL;type=VOICE;waid=' + Queendiana.PHONE + ':' + Queendiana.PHONE + ' \n' +
            'END:VCARD'
    ...
    diana.addqueendiacmd({ queeendiacmd: 'wiki ?(.*)', fromMe: true, desc: Lang.WIKI_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'img ?(.*)', fromMe: true, desc: Lang.IMG_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'lyric ?(.*)', fromMe: true, desc: Slang.LY_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: "covid ?(.*)", fromMe: true, desc: Clang.COV_DESC }, (async(message, match) => {
        if (match[1] === "") {
            try {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: false }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'detectlang$', fromMe: false, desc: dlang_dsc }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: false }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'tts (.*)', fromMe: false, desc: Lang.TTS_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'wiki ?(.*)', fromMe: false, desc: Lang.WIKI_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: '2img ?(.*)', fromMe: false, desc: Lang.IMG_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'song ?(.*)', fromMe: false, desc: Lang.ISONG_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'lyric ?(.*)', fromMe: false, desc: Slang.LY_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'sing ?(.*)', fromMe: false, desc: Lang.SING_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: "covid ?(.*)", fromMe: false, desc: Clang.COV_DESC }, (async(message, match) => {
        if (match[1] === "") {
            try {
                //const resp = await fetch("https://coronavirus-19-api.herokuapp.com/all").then(r => r.json());
                const respo = await got("https://coronavirus-19-api.herokuapp.com/all").then(async ok => {
